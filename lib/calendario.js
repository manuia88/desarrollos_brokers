...
// Dispara (best-effort) la creación del evento en el Google Calendar del asesor.
export async function crearEventoGoogle(cita_id) {
  ...
  } catch { /* si Google no está configurado o el asesor no está conectado, no pasa nada */ }
}
